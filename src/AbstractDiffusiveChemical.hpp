...
void AbstractDiffusiveChemical::AddDiffusiveDomainVector(std::vector<std::string> domainLabelVector, std::vector<double> diffusivityVector)
{
    ...
    {
        std::cout<<"AbstractDiffusiveChemical::AddDiffusiveDomainVector:   Domain vector and diffusivity vector not of equla size"<<std::endl;
    }
...
std::string AbstractDiffusiveChemical::GetDiffusiveDomainByIndex(unsigned index)
{
    ...
    {    
        std::cout<<"AbstractDiffusiveChemical::GetDiffusiveDomainByIndex:   index out of bounds"<<std::endl;
        return "Error";
    }
...
double AbstractDiffusiveChemical::GetChemicalDiffusivityByIndex(unsigned index)
{
    ...
    {    
        std::cout<<"AbstractDiffusiveChemical::GetChemicalDiffusivityByIndex:   index out of bounds"<<std::endl;
        return 0.0;
    }
}
