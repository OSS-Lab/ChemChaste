#ifndef CHEMICALTRACKINGPOSTWITCHMODIFIER_HPP_
#define CHEMICALTRACKINGPOSTWITCHMODIFIER_HPP_
...
class ChemicalTrackingPostSwitchModifier : public AbstractCellBasedSimulationModifier<ELEMENT_DIM,SPACE_DIM>
{
private:
    double mDelta_error;
...
public:
    ...
    ChemicalTrackingPostSwitchModifier();

    virtual ~ChemicalTrackingPostSwitchModifier();
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::ChemicalTrackingPostSwitchModifier()
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM, SPACE_DIM>::UpdateAtEndOfTimeStep(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateAtEndOfTimeStep - start"<<std::endl;
    UpdateCellData(rCellPopulation);
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateAtEndOfTimeStep - end"<<std::endl;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSolve(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation, std::string outputDirectory)
{
    /*
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData - start"<<std::endl;
    ...
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData - end"<<std::endl;
}


template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    // called at the end of a simulation timestep after cell switching and transport/membrane effects, update the transport and membrane properties with 
    // new concentrations and update the SRN reaction concentrations
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData( - start"<<std::endl;
    ...
    std::cout<<"ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData( - end"<<std::endl;

}


template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::OutputSimulationModifierParameters(out_stream& rParamsFile)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetDeltaError(double delta_error)
{
    mDelta_error = delta_error;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::GetDeltaError()
{
    return mDelta_error;
}
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::CheckConcentration(const std::vector<double>& rY)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::CheckConcentration(const double& rY)
{
    // if chemical concentration gets too low then nan can occur, concentration must be +ve
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetIsCheckConcentration(bool IsCheckConcentration)
{
    mIsCheckConcentration = IsCheckConcentration;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
bool ChemicalTrackingPostSwitchModifier<ELEMENT_DIM,SPACE_DIM>::GetIsCheckConcentration()
{
