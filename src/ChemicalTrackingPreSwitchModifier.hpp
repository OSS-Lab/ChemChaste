#ifndef CHEMICALTRACKINGPRESWITCHMODIFIER_HPP_
#define CHEMICALTRACKINGPRESWITCHMODIFIER_HPP_
...
class ChemicalTrackingPreSwitchModifier : public AbstractCellBasedSimulationModifier<ELEMENT_DIM,SPACE_DIM>
{
private:
    double mDelta_error;
...
public:
    ...
    ChemicalTrackingPreSwitchModifier();

    virtual ~ChemicalTrackingPreSwitchModifier();
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::ChemicalTrackingPreSwitchModifier()
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM, SPACE_DIM>::UpdateAtEndOfTimeStep(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateAtEndOfTimeStep - start"<<std::endl;
    UpdateCellData(rCellPopulation);
    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateAtEndOfTimeStep - end"<<std::endl;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSolve(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation, std::string outputDirectory)
{
    /*
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    // run through each cell and use the chemicals defined in the SRN for setting the CellData Names

    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData - start"<<std::endl;
    ...
    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetupSRNFromCellData - end"<<std::endl;
}


template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData(AbstractCellPopulation<ELEMENT_DIM,SPACE_DIM>& rCellPopulation)
{
    // called at end of simulation timestep before the cell decides to switch state, sets the cell data as the output of the SRN model then adds the transport membrane effects

    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData( - start"<<std::endl;
    ...
    std::cout<<"ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::UpdateCellData( - end"<<std::endl;

}


template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::OutputSimulationModifierParameters(out_stream& rParamsFile)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetDeltaError(double delta_error)
{
    mDelta_error = delta_error;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
double ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::GetDeltaError()
{
    return mDelta_error;
}
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::CheckConcentration(const std::vector<double>& rY)
{
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::CheckConcentration(const double& rY)
{
    // if chemical concentration gets too low then nan can occur, concentration must be +ve
...
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
void ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::SetIsCheckConcentration(bool IsCheckConcentration)
{
    mIsCheckConcentration = IsCheckConcentration;
}

template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
bool ChemicalTrackingPreSwitchModifier<ELEMENT_DIM,SPACE_DIM>::GetIsCheckConcentration()
{
